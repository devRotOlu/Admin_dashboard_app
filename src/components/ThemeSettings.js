    ...
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      ...
      <div className='float-right h-screen dark:text-gray-200 bg-white dark:[#484B52] w-400'>
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'>
            ...
            <div md='mt-4'>
                <input type='radio' id='light' value='Light'  name='theme' className='cursor-pointer' onChange={setMode} checked={currentMode==='Light'} />
                <label htmlFor='light' className='ml-2 text-md cursor-pointer' >
                   Light
                </label>
            </div>
            <div md='mt-4'>
                <input type='radio' id='dark' value='Dark'  name='theme' className='cursor-pointer' onChange={setMode} checked={currentMode==='Dark'} />
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'>
            ...
            <div className='flex gap-3'>
              {
                themeColors.map((item, index)=>(<TooltipComponent content={item.name} key={index}>
